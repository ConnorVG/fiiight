...
struct b2VelocityConstraintPoint
{
    ...
    float32 normalMass = 0;
    float32 tangentMass = 0;
    float32 velocityBias = 0;
}

struct b2ContactVelocityConstraint
{
    b2VelocityConstraintPoint[b2_maxManifoldPoints] points = new b2VelocityConstraintPoint[b2_maxManifoldPoints];
    b2Vec2 normal;
    b2Mat22 normalMass;
    b2Mat22 K;
    int32 indexA;
    int32 indexB;
    float32 invMassA = 0, invMassB = 0;
    float32 invIA = 0, invIB = 0;
    float32 friction = 0;
    float32 restitution = 0;
    float32 tangentSpeed = 0;
    int32 pointCount;
    int32 contactIndex;
}
...
struct b2ContactSolver
{
    ...
    this(b2ContactSolverDef* def)
    {
        ...
        for (int32 i = 0; i < m_count; ++i)
        {
            ...
            for (int32 j = 0; j < pointCount; ++j)
            {
                b2ManifoldPoint* cp = manifold.points.ptr + j;
                b2VelocityConstraintPoint* vcp = vc.points.ptr + j;
    ...
    ~this()
    {
        m_allocator.Free(cast(void*)m_velocityConstraints);
        m_allocator.Free(cast(void*)m_positionConstraints);
    }
    ...
    void InitializeVelocityConstraints()
    {
        for (int32 i = 0; i < m_count; ++i)
        {
            ...
            {
                b2VelocityConstraintPoint* vcp1 = vc.points.ptr + 0;
                b2VelocityConstraintPoint* vcp2 = vc.points.ptr + 1;
    ...
    void SolveVelocityConstraints()
    {
        for (int32 i = 0; i < m_count; ++i)
        {
            ...
            {
                for (int32 idx = 0; idx < pointCount; ++idx)
                {
                    b2VelocityConstraintPoint* vcp = vc.points.ptr + idx;
            ...
            else
            {
                ...
                b2VelocityConstraintPoint* cp1 = vc.points.ptr + 0;
                b2VelocityConstraintPoint* cp2 = vc.points.ptr + 1;

                b2Vec2 a = b2Vec2(cp1.normalImpulse, cp2.normalImpulse);
...
struct b2ContactPositionConstraint
{
    ...
    float32 radiusA = 0, radiusB = 0;
    int32 pointCount;
}

struct b2PositionSolverManifold
{
    void Initialize(b2ContactPositionConstraint* pc, b2Transform xfA, b2Transform xfB, int32 index)
    {
